...
-- [[ Colorscheme ]]
--
-- `colors/chinolor.vim` was generated by djanho (a VS Code theme -> vimscript
-- converter) before treesitter and LSP semantic tokens existed. It defines only
-- 24 classic groups (Function, Identifier, Keyword, ...) and nothing for the
-- `@...` capture groups modern Neovim actually uses. Everything it does not
