...
" djanho does not emit this, but Neovim and plugins use g:colors_name to know
" which colorscheme is active. Without it `vim.g.colors_name` stays nil.
set background=dark
let g:colors_name = 'chinolor'
